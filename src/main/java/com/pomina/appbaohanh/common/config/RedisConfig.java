...
import com.pomina.appbaohanh.security.sysmodel.RefreshTokenInfo;
...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, RefreshTokenInfo> redisTemplate(RedisConnectionFactory connectionFactory) {
        RedisTemplate<String, RefreshTokenInfo> template = new RedisTemplate<>();
