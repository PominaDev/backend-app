...
public class RestTemplateConfig {
    ...
    protected RequestConfig requestConfig() {
        return RequestConfig.custom()
                .setConnectionRequestTimeout(10, TimeUnit.SECONDS) // Timeout lấy kết nối từ pool
                .setConnectTimeout(10, TimeUnit.SECONDS) // Timeout thiết lập kết nối
                .setResponseTimeout(20, TimeUnit.SECONDS) // Timeout đọc response
                .build();
    }
    ...
    public RestTemplate restTemplate(PoolingHttpClientConnectionManager connectionManager, RequestConfig requestConfig) {
        ...
        HttpClient httpClient = HttpClients.custom()
                ...
                .evictIdleConnections(TimeValue.ofSeconds(30)) // Xóa kết nối không hoạt động sau 30s: Giảm lãng phí tài nguyên.
                .build();
